...
def find_fragments(mol):
    ...
    # print(Chem.MolToSmiles(new_mol.GetMol()))
    for bond in mol.GetBonds():
...
if __name__ == '__main__':
    sml = 'Cn1c(=O)c2c(ncn2-c2ccc(N)cc2)n(C)c1=O'
    # sml= 'C[n:1]1[c:2](=[O:3])[c:4]2[c:5]([n:6][cH:7][n:8]2)[n:16]([CH3:17])[c:18]1=[O:19]'
    # sml = 'C[n:1]1[c:2](=[O:3])[c:4]2[c:5]([n:6][cH:7][n:8]2)[n:9]([CH3:10])[c:11]1=[O:12]'
    # sml = 'C[n]1[c](=[O])[c]2[c]([n][cH][n]2)[n]([CH3])[c]1=[O]'
    # sml = 'Cn1c(=O)c2c(ncn2)n(C)c1=O'
    # sml = 'Cn1c(=O)c2[nH]cnc2n(C)c1=O'
    # sml = 'COC12C(COC(C)=O)C3=C(C(=O)C(C)=C(N)C3=O)N1CC1NC12'
    sml = 'Cn1c(=O)c2c([nH]cn2)n(C)c1=O'
    ...
    smiles_s = [frag[0] for frag in fragments]
    print('%s>>%s' % (sml, '.'.join(list(set(smiles_s)))))                                                                                                      
