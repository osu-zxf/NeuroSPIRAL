...
val_loader = DataLoader(val_dataset_processed, batch_size=32, shuffle=False)
test_loader = DataLoader(test_dataset_processed, batch_size=32, shuffle=False)
...
Train_Mode = True
model_save_path = 'results/tox21/best_multilevel_gnn_model.pth'
...
if Train_Mode:
    ...
    for epoch in range(1, epochs + 1):
        ...
        model_save_path = 'results/tox21/multilevel_gnn_model' + f'_epoch{epoch}' + '.pth'
